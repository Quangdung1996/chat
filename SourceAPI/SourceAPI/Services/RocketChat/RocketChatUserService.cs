...
public class RocketChatUserService : IRocketChatUserService
{
    ...
    public async Task<SyncUserResponse> SyncUser(int userId, string username, string fullName, string? email = null)
    {
        try
        {
            var existingMapping = GetUserMapping(userId);
    ...
    public RocketUserMapping GetUserMapping(int userId)
    {
        try
        {
    ...
    public RocketUserMapping GetMappingByRocketUserIdAsync(string rocketUserId)
    {
        try
        {
    ...
    public async Task<bool> SetUserActiveStatusAsync(int userId, bool isActive)
    {
        try
        {
            var mapping = GetUserMapping(userId);
            if (mapping == null)
            {
